...
function userpro_remove_connection()
{
	...
	$list = get_user_meta($current_user_id, '_userpro_connected_userlist', true);
	unset($list[$remove_userid]);
	update_user_meta($current_user_id, '_userpro_connected_userlist', $list);
	
	$list = get_user_meta($remove_userid, '_userpro_connected_userlist', true);
...
function userpro_reject_user_request()
{
		...
		$list = get_user_meta($current_user_id, '_userpro_users_request', true);
...
function userpro_accept_user_request()
{
		...
		$userrequest = get_user_meta($current_user_id, '_userpro_connected_userlist', true);
		$userrequest[$requested_userid] = 1;
		update_user_meta($current_user_id, '_userpro_connected_userlist', $userrequest);
		

		
		$requesteduser = get_user_meta($requested_userid, '_userpro_connected_userlist', true);
...
function userpro_connect_user()
{
		...
		$userrequest = get_user_meta($requested_userid, '_userpro_users_request', true);
