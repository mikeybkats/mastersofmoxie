...
if ( !class_exists( 'ReduxFramework_wbc_importer' ) ) {
    ...
    class ReduxFramework_wbc_importer {
        ...
        public function render() {
            ...
            echo '</fieldset></td></tr><tr><td colspan="2"><fieldset id="wbc_importer_wrap" class="redux-field wbc_importer">';
            ...
            echo '</div></div>';
            echo '<div id="info-opt-notice-warning w-clearfix" class="redux-warning   redux-info-field redux-field-info" style="display: block; clear: both; overflow: hidden;">
                        <p class="redux-info-desc"><b>How To Remove Duplicated Menu Items After Importing</b><br>
                            If your menu is duplicated or do not import after importing demo please read <a target="_blank" href="https://webnus.ticksy.com/article/8197/">How To Remove Duplicated Menu Items After Importing</a> Article
                        </p>
                    </div>';
            echo '</fieldset></td></tr>';
