<?php
	...
	Redux::setSection( $opt_name, array(
		...
		'fields'	=> array(
			...
			array(
				...
				'subtitle'	=> esc_html__( 'When you choose dark the text color will be white and when you choose light the text color will be dark.','easyweb'),
				'id'		=> 'easyweb_webnus_footer_color',
				'type'		=> 'switch',
				'default'	=> '0',
				'on'		=> esc_html__( 'Light', 'easyweb' ),
				'off'		=> esc_html__( 'Dark', 'easyweb' ),
			),
		),
	) );
	...
	Redux::setSection( $opt_name, array(
		...
		'fields'	=> array(
			...
			array(
				...
				'type'		=> 'switch',
				'default'	=> '0',
				'on'		=> esc_html__( 'Full', 'easyweb' ),
				'off'		=> esc_html__( 'Excerpt', 'easyweb' ),
			),
			array(
	...
	Redux::setSection( $opt_name, array(
		...
		'fields'			=> array(
			array(
				'title'			=> esc_html__( 'Menu Typography', 'easyweb' ),
				'subtitle'		=> esc_html__( 'These settings control the typography for all Menu.', 'easyweb' ),
				'id'			=> 'menu-typography',
				'type'			=> 'typography',
				'all_styles'	=> true,
				'letter-spacing'=> true,
