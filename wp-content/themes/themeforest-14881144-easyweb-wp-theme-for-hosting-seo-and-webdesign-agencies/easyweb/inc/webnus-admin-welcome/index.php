				...
				<div class="w-col-sm-6">
					<div class="w-box doc">
						...
						<div class="w-box-content">
							...
							<div class="w-button">
								<a href="<?php echo admin_url("themes.php?page=tgmpa-install-plugins"); ?>" target="_blank"><?php echo esc_html__('DOCUMENTATION','easyweb'); ?></a>
							</div>
						</div>
					</div>
				</div>
				<div class="w-col-sm-6">
					<div class="w-box support">
						...
						<div class="w-box-content">
							...
							<div class="w-button">
								<a href="<?php echo admin_url("themes.php?page=tgmpa-install-plugins"); ?>" target="_blank"><?php echo esc_html__('OPEN A TICKET','easyweb'); ?></a>
							</div>
						</div>
					</div>
				</div>
