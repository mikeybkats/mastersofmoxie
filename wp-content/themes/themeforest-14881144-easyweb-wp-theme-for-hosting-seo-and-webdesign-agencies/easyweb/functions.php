...
function easyweb_webnus_topbar($pos){
	...
	if ( is_plugin_active('polylang/polylang.php' ) && $easyweb_webnus_options['easyweb_webnus_polylang_flags']==$pos ) :
		echo '<div class="polylang-flags">';
			the_widget( 'PLL_Widget_Languages', 'show_flags=1&show_names=0' );
		echo '</div>';
	endif;
